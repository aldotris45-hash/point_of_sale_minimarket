...
<head>
    <meta charset="UTF-8">
    <title>Masuk - <?php echo e($appStoreName ?? config('app.name', 'POS')); ?></title>
        ...
        <div class="auth-card card shadow-sm border-0">
            <div class="card-body p-4 p-md-4">
                <header class="mb-3 text-center">
                    <div class="brand">
                        <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" width="56" height="56"
                            class="rounded-circle">
                    </div>
                    <div class="text-center">
                        <div class="brand-title"><?php echo e($appStoreName ?? config('app.name', 'POS')); ?></div>
                ...
                <form id="loginForm" action="<?php echo e(url('/login')); ?>" method="POST" novalidate>
                    <?php echo csrf_field(); ?>
                    <fieldset class="mb-3">
...
<?php /**PATH C:\Users\nwlen\Documents\point_of_sale_minimarket.worktrees\copilot-worktree-2026-03-10T06-54-12\resources\views/auth/login.blade.php ENDPATH**/ ?>