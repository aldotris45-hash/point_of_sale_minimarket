    ...
    <section class="container py-4">
        ...
        <section class="row row-cols-1 row-cols-md-2 row-cols-xxl-6 g-3">
            <article class="col">
                ...
                echo $__prefix . number_format($salesToday, 0, ',', '.');
            ?></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="h4 mb-0"><?php echo e(number_format($trxToday, 0, ',', '.')); ?></h2>
                        </div>
                    </div>
                </div>
            </article>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="h4 mb-0"><?php echo e(number_format($outOfStock, 0, ',', '.')); ?></h2>
                        </div>
                    </div>
                </div>
            </article>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="h4 mb-0"><?php echo e(number_format($lowStock, 0, ',', '.')); ?></h2>
                        </div>
                    </div>
                </div>
            </article>
            <article class="col">
                ...
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($sales7days, 0, ',', '.');
            ?></h2>
                        </div>
                    </div>
                </div>
            ...
            <article class="col">
                ...
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($aov7days, 0, ',', '.');
            ?></h2>
                        </div>
                    </div>
                </div>
                        ...
                        <?php else: ?>
                            <div class="table-responsive">
                                <table class="table table-sm align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $topToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                ...
                <div class="card shadow-sm">
                    <div class="card-body d-flex flex-wrap gap-3 justify-content-between">
                        <div>
                            ...
                            <div class="fw-semibold"><?php echo e(number_format($items7days, 0, ',', '.')); ?></div>
                        </div>
                        <div>
                            <div class="text-muted">Transaksi (7 hari)</div>
                            <div class="fw-semibold"><?php echo e(number_format($trx7days, 0, ',', '.')); ?></div>
                        </div>
                        <div>
                            <div class="text-muted">Hari Terbaik</div>
                            <div class="fw-semibold"><?php echo e($bestDay['label'] ?? '-'); ?> (<?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($bestDay['value'] ?? 0, 0, ',', '.');
            ?>)</div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        (function() {
            ...
            const rawValues = <?php echo json_encode($chartValues, 15, 512) ?>;
            const values = (rawValues || []).map(v => Number(v) || 0);
            const currencyCode = '<?php echo e(strtoupper($currency ?? ($appCurrency ?? 'IDR'))); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nwlen\Documents\point_of_sale_minimarket.worktrees\copilot-worktree-2026-03-10T06-54-12\resources\views/home.blade.php ENDPATH**/ ?>