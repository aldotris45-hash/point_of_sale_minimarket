...
<?php $__env->startSection('content'); ?>
    <section class="container-fluid py-4">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h1 class="h3 mb-0"><i class="bi bi-receipt"></i> Transaksi <?php echo e($trx->invoice_number); ?></h1>
            <div class="d-flex gap-2">
                <a class="btn btn-outline-secondary" href="<?php echo e(route('transaksi')); ?>"><i class="bi bi-arrow-left"></i>
                    Kembali</a>
                <a class="btn btn-primary" href="<?php echo e(route('transaksi.struk', $trx)); ?>" target="_blank"
                    rel="noopener noreferrer"><i class="bi bi-printer"></i> Cetak Struk</a>
                <a class="btn btn-info text-white print-btn" data-base-url="<?php echo e(route('transaksi.invoice', $trx)); ?>" href="<?php echo e(route('transaksi.invoice', $trx)); ?>" target="_blank"
                    rel="noopener noreferrer"><i class="bi bi-file-earmark-text"></i> Cetak Invoice</a>
                <a class="btn btn-success print-btn" data-base-url="<?php echo e(route('transaksi.faktur', $trx)); ?>" href="<?php echo e(route('transaksi.faktur', $trx)); ?>" target="_blank"
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="<?php echo e('https://wa.me/?text=' . rawurlencode("*Struk Pembayaran*\nNo: {$trx->invoice_number}\nTotal: Rp " . number_format($trx->total, 0, ',', '.') . "\n\nDownload PDF:\n" . route('transaksi.struk.pdf', $trx))); ?>" target="_blank" rel="noopener noreferrer">
                                <i class="bi bi-receipt-cutoff"></i> Struk via WA
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item wa-print-btn" data-wa-base-text="<?php echo e(rawurlencode("*Invoice*\nNo: {$trx->invoice_number}\nTotal: Rp " . number_format($trx->total, 0, ',', '.') . "\n\nDownload PDF:\n")); ?>" data-base-url="<?php echo e(route('transaksi.invoice.pdf', $trx)); ?>" href="<?php echo e('https://wa.me/?text=' . rawurlencode("*Invoice*\nNo: {$trx->invoice_number}\nTotal: Rp " . number_format($trx->total, 0, ',', '.') . "\n\nDownload PDF:\n" . route('transaksi.invoice.pdf', $trx))); ?>" target="_blank" rel="noopener noreferrer">
                                <i class="bi bi-file-earmark-text"></i> Invoice via WA
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item wa-print-btn" data-wa-base-text="<?php echo e(rawurlencode("*Faktur Penjualan*\nNo: {$trx->invoice_number}\nTotal: Rp " . number_format($trx->total, 0, ',', '.') . "\n\nDownload PDF:\n")); ?>" data-base-url="<?php echo e(route('transaksi.faktur.pdf', $trx)); ?>" href="<?php echo e('https://wa.me/?text=' . rawurlencode("*Faktur Penjualan*\nNo: {$trx->invoice_number}\nTotal: Rp " . number_format($trx->total, 0, ',', '.') . "\n\nDownload PDF:\n" . route('transaksi.faktur.pdf', $trx))); ?>" target="_blank" rel="noopener noreferrer">
                                <i class="bi bi-receipt"></i> Faktur via WA
                            </a>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('transaksi.struk.pdf', $trx)); ?>">
                                <i class="bi bi-file-earmark-pdf"></i> Download Struk PDF
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item print-btn" data-base-url="<?php echo e(route('transaksi.invoice.pdf', $trx)); ?>" href="<?php echo e(route('transaksi.invoice.pdf', $trx)); ?>">
                                <i class="bi bi-file-earmark-pdf"></i> Download Invoice PDF
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item print-btn" data-base-url="<?php echo e(route('transaksi.faktur.pdf', $trx)); ?>" href="<?php echo e(route('transaksi.faktur.pdf', $trx)); ?>">
                                <i class="bi bi-file-earmark-pdf"></i> Download Faktur PDF
                            </a>
                        </li>
                    </ul>
                </div>
                <?php if(auth()->user()->role === \App\Enums\RoleStatus::ADMIN->value): ?>
                    <form action="<?php echo e(route('transaksi.destroy', $trx)); ?>" method="POST" class="d-inline"
                        onsubmit="return confirm('Yakin hapus transaksi <?php echo e($trx->invoice_number); ?>? Stok produk akan dikembalikan.')">
                        <?php echo csrf_field(); ?>
        ...
        <div class="row g-3">
            <div class="col-12 col-lg-7">
                        ...
                        <div class="row small">
                            <div class="col-md-6">
                                <div><span class="text-muted">Tanggal</span>
                                    <div><?php echo e($trx->created_at->format('d/m/Y H:i')); ?></div>
                                </div>
                                <div class="mt-2"><span class="text-muted">Kasir</span>
                                    <div><?php echo e($trx->user->name ?? '-'); ?></div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <?php $s = $trx->status->value ?? $trx->status; ?>
                                <div><span class="text-muted">Status</span>
                                    <div><span
                                            class="badge <?php echo e($s === 'paid' ? 'bg-success' : ($s === 'pending' ? 'bg-warning text-dark' : 'bg-secondary')); ?>"><?php echo e(strtoupper($s)); ?></span>
                                    </div>
                                </div>
                ...
                echo $__prefix . number_format($trx->total, 0, ',', '.');
            ?></div>
                                </div>
                ...
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($trx->amount_paid, 0, ',', '.');
            ?></div>
                                </div>
                ...
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($trx->change, 0, ',', '.');
            ?></div>
                                </div>
                                <?php if((($trx->payment_method->value ?? $trx->payment_method) === 'cash_tempo') && $trx->amount_paid < $trx->total): ?>
                                    <div class="mt-2"><span class="text-muted">Piutang</span>
                                        <div><?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($trx->total - $trx->amount_paid, 0, ',', '.');
            ?></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <table class="table table-sm align-middle">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $trx->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo e($d->product->name ?? '#' . $d->product_id); ?></td>
                                            <td class="text-end"><?php echo e($qtyFmt); ?> <?php echo e($saleUnit); ?></td>
                                            <td class="text-end">Rp <?php echo e(number_format($d->price, 0, ',', '.')); ?>/<?php echo e($saleUnit); ?></td>
                                            <td class="text-end">Rp <?php echo e(number_format($d->total, 0, ',', '.')); ?></td>
                                        </tr>
            ...
            <div class="col-12 col-lg-5">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="small">
                            <div class="d-flex justify-content-between"><span>Subtotal</span><span><?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($trx->subtotal, 0, ',', '.');
            ?></span>
                            </div>
                            <div class="d-flex justify-content-between"><span>Diskon</span><span><?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($trx->discount, 0, ',', '.');
            ?></span>
                            </div>
                            <div class="d-flex justify-content-between"><span>Pajak</span><span><?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($trx->tax, 0, ',', '.');
            ?></span>
                            </div>
                            <div class="d-flex justify-content-between fw-bold border-top pt-1">
                                <span>Total</span><span><?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
                echo $__prefix . number_format($trx->total, 0, ',', '.');
            ?></span>
                        ...
                        <div class="d-grid gap-2 mt-3">
                            <a class="btn btn-outline-secondary" href="<?php echo e(route('transaksi.struk', $trx)); ?>"
                            ...
                            <div class="border rounded p-2 bg-light">
                                ...
                                <div class="d-flex gap-2">
                                    <a class="btn btn-outline-info flex-fill print-btn" data-base-url="<?php echo e(route('transaksi.invoice', $trx)); ?>"
                                        href="<?php echo e(route('transaksi.invoice', $trx)); ?>" target="_blank" rel="noopener noreferrer">
                                        <i class="bi bi-printer"></i> Cetak Html
                                    </a>
                                    <a class="btn btn-outline-success flex-fill print-btn" data-base-url="<?php echo e(route('transaksi.faktur', $trx)); ?>"
                                        href="<?php echo e(route('transaksi.faktur', $trx)); ?>" target="_blank" rel="noopener noreferrer">
                                        <i class="bi bi-printer"></i> Faktur Html
                                    </a>
                                </div>
                                <div class="d-flex gap-2 mt-2">
                                    <a class="btn btn-info text-white flex-fill print-btn" data-base-url="<?php echo e(route('transaksi.invoice.pdf', $trx)); ?>"
                                        href="<?php echo e(route('transaksi.invoice.pdf', $trx)); ?>">
                                        <i class="bi bi-file-earmark-pdf"></i> Download Invoice PDF
                                    </a>
                                    <a class="btn btn-success flex-fill print-btn" data-base-url="<?php echo e(route('transaksi.faktur.pdf', $trx)); ?>"
                                        href="<?php echo e(route('transaksi.faktur.pdf', $trx)); ?>">
                                        <i class="bi bi-file-earmark-pdf"></i> Download Faktur PDF
                                    </a>
                                </div>
                            </div>
                        ...
                        <?php
                            $pm = $trx->payment_method->value ?? $trx->payment_method;
                        ?>
                        <?php if($pm === 'cash_tempo' && $trx->amount_paid < $trx->total): ?>
                            <section class="card shadow-sm mt-3">
                                <div class="card-body">
                                    <h5 class="h6">Bayar Sisa (Piutang)</h5>
                                    <form action="<?php echo e(route('transaksi.lunas', $trx)); ?>" method="POST" class="row g-2">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nwlen\Documents\selalu_fresh\resources\views/transactions/show.blade.php ENDPATH**/ ?>