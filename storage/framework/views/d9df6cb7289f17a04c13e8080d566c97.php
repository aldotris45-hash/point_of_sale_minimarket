        ...
        <div class="row g-3 align-items-center justify-content-between text-center text-md-start">
            <div
                ...
                <span class="text-truncate" style="max-width: 60vw">
                    &copy; <?php echo e(date('Y')); ?> <?php echo e($appStoreName ?? config('app.name', 'POS')); ?>

                </span>
            </div>

            <?php if(!empty($appStoreAddress)): ?>
                <div class="col-12 col-sm-auto">
                    <span class="d-inline-flex align-items-center gap-1">
                        <i class="bi bi-geo-alt"></i>
                        <span class="text-wrap"><?php echo e($appStoreAddress); ?></span>
                    </span>
                </div>
            <?php endif; ?>

            <?php if(!empty($appStorePhone)): ?>
                <div class="col-12 col-sm-auto">
                    <a class="link-secondary text-decoration-none d-inline-flex align-items-center gap-1"
                        href="tel:<?php echo e(preg_replace('/\s+/', '', $appStorePhone)); ?>">
                        <i class="bi bi-telephone"></i>
                        <span><?php echo e($appStorePhone); ?></span>
                    </a>
                </div>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\Users\nwlen\Documents\point_of_sale_minimarket.worktrees\copilot-worktree-2026-03-10T06-54-12\resources\views/layouts/footer.blade.php ENDPATH**/ ?>