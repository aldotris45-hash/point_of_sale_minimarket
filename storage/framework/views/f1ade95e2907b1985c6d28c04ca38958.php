...
<div class="container mb-5 pb-5">
    ...
    <?php if($promoProducts->isNotEmpty() && !$categoryId && !$search): ?>
    <div class="promo-section">
        <div class="promo-banner">
            ...
            <div>
                ...
                <p class="promo-sub">Dapatkan harga spesial sebelum kehabisan &bull; <?php echo e($promoProducts->count()); ?> produk promo</p>
            </div>
            <div class="promo-badge">HEMAT SEKARANG!</div>
        </div>
        <div class="promo-body">
            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-3">
                <?php $__currentLoopData = $promoProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="col">
                    <div class="promo-card">
                        <span class="promo-pill"><?php echo e($label); ?></span>
                        <p class="product-name"><?php echo e($p->name); ?></p>
                        <div>
                            <div class="price-original">Rp <?php echo e(number_format((float)$p->price, 0, ',', '.')); ?></div>
                            <div class="price-promo">Rp <?php echo e(number_format((float)$p->promo_price, 0, ',', '.')); ?></div>
                            <div class="price-hemat">💚 Hemat Rp <?php echo e(number_format($hemat, 0, ',', '.')); ?></div>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-3">
                    ...
                    <div class="col">
                        <div class="product-card">
                            <?php if($product->isOnPromo()): ?>
                                <span class="promo-mini-badge">🔥 Promo</span>
                            <?php endif; ?>
                            <p class="product-name"><?php echo e($product->name); ?></p>
                            <div>
                                <?php if($product->isOnPromo()): ?>
                                    <div style="font-size:0.78rem;color:#9ca3af;text-decoration:line-through;">Rp <?php echo e(number_format((float)$product->price, 0, ',', '.')); ?></div>
                                    <div class="product-price" style="color:#dc2626;">Rp <?php echo e(number_format((float)$product->promo_price, 0, ',', '.')); ?></div>
...
<div class="promo-overlay" id="promoOverlay" role="dialog" aria-modal="true" aria-labelledby="promoModalTitle">
    <div class="promo-modal">
        ...
        <div class="promo-modal-header">
            ...
            <p>Harga spesial untuk <?php echo e($promoProducts->count()); ?> produk — jangan sampai kehabisan!</p>
        </div>
            ...
            <div class="row row-cols-2 g-3">
                ...
                <div class="col">
                    <div class="promo-modal-card">
                        <span class="pill"><?php echo e($label); ?></span>
                        <p class="pname"><?php echo e($p->name); ?></p>
                        <div class="pold">Rp <?php echo e(number_format((float)$p->price, 0, ',', '.')); ?></div>
                        <div class="pnew">Rp <?php echo e(number_format((float)$p->promo_price, 0, ',', '.')); ?></div>
                        <div class="psave">💚 Hemat Rp <?php echo e(number_format($hemat, 0, ',', '.')); ?></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<script>
(function () {
    const STORAGE_KEY = 'promo_popup_seen_<?php echo e(md5($promoProducts->pluck("id")->sort()->implode(","))); ?>';
...
<?php /**PATH C:\Users\nwlen\Documents\selalu_fresh\resources\views/catalog/index.blade.php ENDPATH**/ ?>