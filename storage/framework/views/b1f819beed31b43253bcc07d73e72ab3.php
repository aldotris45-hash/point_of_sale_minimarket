        ...
        <div class="row g-3">
                                    ...
                                    <?php $__currentLoopData = $dailyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-end text-success">
                                                <?php if($day['income'] > 0): ?>
                                                <a href="#" class="text-success text-decoration-none border-bottom border-success border-opacity-25 show-detail" data-date="<?php echo e($day['date_raw']); ?>" data-type="income">
                                                    <?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
            ...
            ?>
                                            ...
                                            <td class="text-end text-warning">
                                                <?php if($day['purchase'] > 0): ?>
                                                <a href="#" class="text-warning text-decoration-none border-bottom border-warning border-opacity-25 show-detail" data-date="<?php echo e($day['date_raw']); ?>" data-type="purchase">
                                                    <?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
            ...
            ?>
                                            ...
                                            <td class="text-end text-danger">
                                                <?php if($day['operational'] > 0): ?>
                                                <a href="#" class="text-danger text-decoration-none border-bottom border-danger border-opacity-25 show-detail" data-date="<?php echo e($day['date_raw']); ?>" data-type="operational">
                                                    <?php
                $__cur = app(\App\Services\Settings\SettingsServiceInterface::class)->currency();
                $__code = is_string($__cur) ? strtoupper($__cur) : 'IDR';
                $__prefix = $__code === 'IDR' ? 'Rp ' : ($__code . ' ');
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('dailyTable').addEventListener('click', function(e) {
                ...
                // Fetch details
                fetch(`<?php echo e(route('arus-kas.detail')); ?>?date=${date}&type=${type}`)
                    .then(response => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nwlen\Documents\selalu_fresh\resources\views/cash_flow/index.blade.php ENDPATH**/ ?>