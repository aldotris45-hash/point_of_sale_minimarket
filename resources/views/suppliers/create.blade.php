    ...
    <section class="container py-4">
        <div class="mb-3">
            <h1 class="h3 d-flex align-items-center gap-2 mb-1">
                <i class="bi bi-building"></i> Tambah Supplier
            </h1>
            <p class="text-muted mb-0">Isi data supplier baru.</p>
        </div>
                ...
                <form action="{{ route('supplier.store') }}" method="POST" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                            value="{{ old('name') }}" required maxlength="255" placeholder="Nama supplier">
                        @error('name')
