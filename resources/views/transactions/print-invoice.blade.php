...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .customer-box .label { font-size: 9pt; color: #555; }
...
<body>
    <div class="page">
                ...
                <tr>
                    <td style="width: 60%;">
                        <table class="layout-table"><tr>
                            @if($store_logo)
                                <td style="width: 60px; padding-right: 10px;"><img src="{{ asset($store_logo) }}" alt="Logo" style="max-height: 50px; max-width: 50px;"></td>
                            @endif
                            <td>
        ...
        <div class="meta-section">
            <table class="layout-table">
                <tr>
                    <td class="customer-box" style="width: 55%;">
