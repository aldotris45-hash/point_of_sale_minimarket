            ...
            <div class="col-12 col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="mb-0">Edit Harga Produk Sayur</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('harga-produk.update', $productPrice) }}" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                                ...
                                <select id="product_id" name="product_id" class="form-select @error('product_id') is-invalid @enderror" required>
                                    ...
                                    @foreach ($products as $product)
                                        <option value="{{ $product->id }}" 
                                            {{ old('product_id', $productPrice->product_id) == $product->id ? 'selected' : '' }}>
                                            {{ $product->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="cost_price" name="cost_price" 
                                        value="{{ old('cost_price', number_format($productPrice->cost_price, 0, '', '')) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="selling_price" name="selling_price" 
                                        value="{{ old('selling_price', number_format($productPrice->selling_price, 0, '', '')) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="price_date" name="price_date" 
                                    value="{{ old('price_date', $productPrice->price_date->format('Y-m-d')) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="notes" name="notes" rows="2" 
                                    ...
                                    placeholder="Contoh: Harga naik karena cuaca, stok terbatas, dsb.">{{ old('notes', $productPrice->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
